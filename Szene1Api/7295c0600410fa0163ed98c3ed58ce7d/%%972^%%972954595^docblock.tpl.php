...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'docblock.tpl', 3, false),)), $this); ?>
<?php if ($this->_tpl_vars['sdesc'] != ''): ?>
<p class="shortdesc">
    <?php echo ((is_array($_tmp=@$this->_tpl_vars['sdesc'])) ? $this->_run_mod_handler('default', true, $_tmp, '') : smarty_modifier_default($_tmp, '')); ?>
...
?>
	    <dt><?php echo $this->_tpl_vars['tags'][$this->_sections['tag']['index']]['keyword']; ?>
</dt>
	    <dd><?php echo $this->_tpl_vars['tags'][$this->_sections['tag']['index']]['data']; ?>
</dd>
    <?php endfor; endif; ?>
    </dl>
</div>
