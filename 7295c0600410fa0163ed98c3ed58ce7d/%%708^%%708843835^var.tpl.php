...
"></a>
	<p></p>
	<h4>static <?php echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['var_name'];  if ($this->_tpl_vars['vars'][$this->_sections['vars']['index']]['has_default']): ?> = <span class="value"><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['vars'][$this->_sections['vars']['index']]['var_default'])) ? $this->_run_mod_handler('replace', true, $_tmp, "\n", "<br>\n") : smarty_modifier_replace($_tmp, "\n", "<br>\n")))) ? $this->_run_mod_handler('replace', true, $_tmp, ' ', "&nbsp;") : smarty_modifier_replace($_tmp, ' ', "&nbsp;")))) ? $this->_run_mod_handler('replace', true, $_tmp, "\t", "&nbsp;&nbsp;&nbsp;") : smarty_modifier_replace($_tmp, "\t", "&nbsp;&nbsp;&nbsp;")); ?>
</span><?php endif; ?></h4>
	<div class="indent">
...
"></a>
	<p></p>
	<h4><?php echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['var_name'];  if ($this->_tpl_vars['vars'][$this->_sections['vars']['index']]['has_default']): ?> = <span class="value"><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['vars'][$this->_sections['vars']['index']]['var_default'])) ? $this->_run_mod_handler('replace', true, $_tmp, "\n", "<br>\n") : smarty_modifier_replace($_tmp, "\n", "<br>\n")))) ? $this->_run_mod_handler('replace', true, $_tmp, ' ', "&nbsp;") : smarty_modifier_replace($_tmp, ' ', "&nbsp;")))) ? $this->_run_mod_handler('replace', true, $_tmp, "\t", "&nbsp;&nbsp;&nbsp;") : smarty_modifier_replace($_tmp, "\t", "&nbsp;&nbsp;&nbsp;")); ?>
</span><?php endif; ?></h4>
	<div class="indent">
		<p class="linenumber">[line <?php if ($this->_tpl_vars['vars'][$this->_sections['vars']['index']]['slink']):  echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['slink'];  else:  echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['line_number'];  endif; ?>]</p>
		<?php $_smarty_tpl_vars = $this->_tpl_vars;
