...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'global.tpl', 26, false),)), $this); ?>
...
<p class="summary">
    global variable 
    <a href="<?php echo $this->_tpl_vars['globals'][$this->_sections['glob']['index']]['id']; ?>
"><?php echo $this->_tpl_vars['globals'][$this->_sections['glob']['index']]['global_name']; ?>
</a> 
    = <?php echo $this->_tpl_vars['globals'][$this->_sections['glob']['index']]['global_value']; ?>
...
"></a>
	<h3><em><?php echo $this->_tpl_vars['globals'][$this->_sections['glob']['index']]['global_type']; ?>
</em> <?php echo $this->_tpl_vars['globals'][$this->_sections['glob']['index']]['global_name']; ?>
</h3>
	
	<div class="indent">
	    <p class="linenumber">
	        [line <?php if ($this->_tpl_vars['globals'][$this->_sections['glob']['index']]['slink']):  echo $this->_tpl_vars['globals'][$this->_sections['glob']['index']]['slink'];  else:  echo $this->_tpl_vars['globals'][$this->_sections['glob']['index']]['line_number'];  endif; ?>]
        </p>
